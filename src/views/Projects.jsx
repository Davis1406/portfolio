...
function ProjectCard({ project, onOpen, eager }) {
  ...
  if (isWide) {
    return (
      ...
      >
        {/* Left: self-stretch fills full card height; screenshot retaken at matching 1.42:1 ratio */}
        <div className="md:w-1/2 h-[200px] md:h-auto md:self-stretch shrink-0 overflow-hidden relative">
          <div
